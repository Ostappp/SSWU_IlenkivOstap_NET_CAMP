...
{
    internal class IceCream : IOffer
    {
        ...
        public Menu.OfferType OrderType { get => Menu.OfferType.Dessert; }
        ...
        public IceCream(string name, TimeOnly preparationTime, string description)
        {
